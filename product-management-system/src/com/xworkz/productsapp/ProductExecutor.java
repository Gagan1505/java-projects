...
import com.xworkz.productsapp.dmart.DMart;
...
public class ProductExecutor {
    public static void main(String[] args) {
        ...
        DMart dMart = new DMart(productCount);
        ...
        do {
            ...
            switch (option){
                ...
                case 2 : System.out.println("Enter the product name to get it's details: ");
                    ...
                    System.out.println("ID: " + newProduct.getProductId() +
                            ...
                            "Company: " + newProduct.getCompanyName() +
                            "Mfg-Date: " + newProduct.getMfgDate() +
                            "EXP-Date: " + newProduct.getExpDate() +
                            "Country: " + newProduct.getManufacturedCountry()+
                            "Price: " + newProduct.getPrice());
                    break;

                case 3 : System.out.println("Enter the company name to get products manufactured by it: ");
                    String newProducts[] = dMart.getProductNamesByCompanyName(sc.next());
                    for (int i = 0; i < newProducts.length; i++) {
                        System.out.println(newProducts[i]);
                    }
                    break;

                case 4 : System.out.println("Enter the product name, new manufactured date and new expiry date to update: ");
                    dMart.updateMfgAndExpDatesByProductName(sc.next(),sc.next(),sc.next());
                    break;

                case 5 : System.out.println("Enter the expiry date of a product to delete: ");
